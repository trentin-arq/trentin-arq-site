  ...
  return(
    <div className="about-page-images">
      <div className="definitions">
        <img src="../images/murilo.png" alt="murilo-trentin" loading="lazy" className="about-image" width={280}/>
      ...
      <div className="definitions">
        <img src="../images/julia.png" alt="julia-allgayer" loading="lazy" className="about-image" width={280}/>
